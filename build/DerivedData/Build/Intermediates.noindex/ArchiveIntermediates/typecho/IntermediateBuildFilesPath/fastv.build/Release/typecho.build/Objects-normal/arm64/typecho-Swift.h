...
#ifndef TYPECHO_SWIFT_H
#define TYPECHO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="typecho",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
/// 应用代理，用于监听应用退出事件
SWIFT_CLASS("_TtC7typecho11AppDelegate")
...
/// 下载任务代理
SWIFT_CLASS("_TtC7typecho20DownloadTaskDelegate")
...
SWIFT_CLASS("_TtC7typecho16StatusBarManager")
@interface StatusBarManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

/// 窗口委托，用于监听窗口关闭事件
SWIFT_CLASS("_TtC7typecho14WindowDelegate")
@interface WindowDelegate : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (void)windowDidClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
